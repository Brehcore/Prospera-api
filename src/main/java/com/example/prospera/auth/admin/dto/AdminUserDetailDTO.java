...
public record AdminUserDetailDTO(
    ...
    public record PersonalProfileInfo(String fullName, String cpf, LocalDate birthDate, String phone) {
        public static PersonalProfileInfo fromEntity(com.example.prospera.auth.domain.UserProfilePF pf) {
    ...
    public record MembershipInfo(
        ...
        public static MembershipInfo fromEntity(com.example.prospera.enterprise.domain.Membership m) {
